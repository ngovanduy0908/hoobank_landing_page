  ...
  return (
    ...
    >
      <div className={layout.sectionImgReverse}>
        ...
        <div className="absolute z-[3] -left-1/2 w-[50%]
        top-0 h-[50%] rounded-full white__gradient" />

        <div className="absolute z-[0] -left-1/2 w-[50%]
        bottom-0 h-[50%] rounded-full pink__gradient" />
